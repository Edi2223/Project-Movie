...
class UserController {
    ...
    public function addUser($email, $password, $role) {
        ...
        $user = new User(null, $email, $hashedPassword, $role, $pdo); // The "null" ID will be auto-generated by the database
...
// Add a new user
// $result = $userController->addUser("user@example.com", "password123", "user");
// echo $result;
...
// Delete a user
// $deleteResult = $userController->deleteUser(2);
// echo $deleteResult;
